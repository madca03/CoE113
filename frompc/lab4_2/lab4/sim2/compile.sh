...
java -jar ~/Downloads/Mars4_5.jar a dump .text HexText instmem.txt mc CompactTextAtZero ../asm/test3.asm
java -jar ~/Downloads/Mars4_5.jar a dump .text HexText datamem.txt mc CompactDataAtZero ../asm/test3.asm
java -jar ~/Downloads/Mars4_5.jar a dump .text HexText datamem_ans.txt mc CompactDataAtZero ../asm/test3.asm
...
#iverilog -o simv ./datamem.v ./instmem.v ./tb_pipelined_mips.v ../rtl/pipelined_mips.v ./defines.h
#./simv
