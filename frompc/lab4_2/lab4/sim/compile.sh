...
java -jar ~/Downloads/Mars4_5.jar a dump .text HexText instmem.txt mc CompactTextAtZero ../asm/test.asm
java -jar ~/Downloads/Mars4_5.jar a dump .data HexText datamem.txt mc CompactDataAtZero ../asm/test.asm
...
#iverilog -o simv ../rtl/instmem.v ../rtl/datamem.v ../mapped/pipelined_mips_mapped.v tb_pipelined_mips.v ../rtl/defines.h
#vcs ../rtl/instmem.v ../rtl/datamem.v ../mapped/pipelined_mips_mapped.v ../lib/saed90nm.v tb_pipelined_mips.v ../rtl/defines.h -debug_pp -full64 +neg_tchk -R -l vcs.log
#vcs ../rtl/instmem.v ../rtl/datamem.v ../rtl/pipelined_mips.v tb_pipelined_mips.v ../rtl/defines.h -debug_pp -full64 +neg_tchk -R -l vcs.log
vcs ../rtl/instmem.v ../rtl/datamem.v ../mapped/pipelined_mips_mapped.v ../lib/saed90nm.v tb_pipelined_mips.v -debug_pp -full64 +neg_tchk -R -l vcs.log
./simv
# gtkwave pipelined_mips.vcd
