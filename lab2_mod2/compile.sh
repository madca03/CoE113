java -jar $MARS_BIN/Mars4_5.jar a dump .text HexText instmem.txt dump .data HexText datamem.txt mc CompactDataAtZero test.asm
java -jar $MARS_BIN/Mars4_5.jar dump .data HexText datamem_ans.txt mc CompactDataAtZero test.asm
